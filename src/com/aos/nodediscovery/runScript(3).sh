remoteuser=axr108820
remotecomputer1=net11.utdallas.edu
remotecomputer2=net12.utdallas.edu
remotecomputer3=net10.utdallas.edu
remotecomputer4=net14.utdallas.edu
remotecomputer5=net15.utdallas.edu
remotecomputer6=net16.utdallas.edu
remotecomputer7=net17.utdallas.edu

ssh -l "$remoteuser" "$remotecomputer1" "cd $HOME/AOS/Project1;java Project1 0" &
ssh -l "$remoteuser" "$remotecomputer2" "cd $HOME/AOS/Project1;java Project1 1" &
ssh -l "$remoteuser" "$remotecomputer3" "cd $HOME/AOS/Project1;java Project1 2" &
ssh -l "$remoteuser" "$remotecomputer4" "cd $HOME/AOS/Project1;java Project1 3" &
